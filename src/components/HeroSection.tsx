        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <motion.h2 
              ...
              className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-4 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
            >
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl text-[#FF6700] font-semibold mb-8 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]"
            >
              🇩🇪 From Germany to the World • Your European Air Cargo Partner
            </motion.p>
          </div>
        </div>
      </div>
